    ...
    return {
        ...
        "required_config": (
            ...
            },
            {
                ...
                "endpoint": "/config/apply",
                "status": _activation_item_status(config, "channel_targets"),
                "secret_fields": (
                    "feishu_app_id",
                    "feishu_app_secret",
                    "feishu_verification_token",
                ...
                "detail": "至少配置一个真实渠道 target、对应密钥和 webhook 地址，才能进入外部收发测试。",
            },
        ),
        "required_storage": (
        ...
        "verification": (
            ...
            {"label": "渠道诊断", "method": "GET", "path": "/channels/diagnostics"},
        ),
        "safety": {
            "secret_echo": False,
